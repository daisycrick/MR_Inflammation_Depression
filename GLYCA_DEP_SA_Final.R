rm(list = ls())
setwd("C:/Users/dc15053/OneDrive - University of Bristol/Documents/PhD/year two/SMFQ and GlycA/two sample/GlycA_Depression_SA") # Set the file path to your local directory
...
mr_report(
  dat,
  output_path = "C:/Users/dc15053/OneDrive - University of Bristol/Documents/PhD/year two/SMFQ and GlycA/two sample/GlycA_Depression_SA",
  output_type = "html",
  author = "Analyst",
  study = "Two Sample MR",
